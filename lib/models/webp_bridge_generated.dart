...
abstract class Rust {
  ...
  Future<Uint8List> upscaleFramesWithPadding(
...
class RustImpl implements Rust {
  ...
  Future<Uint8List> upscaleFramesWithPadding(
    ...
    var arg3 = _platform.api2wire_box_autoadd_encoding_config(config);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_upscale_frames_with_padding(port_, arg0, arg1, arg2, arg3),
      parseSuccessData: _wire2api_uint_8_list,
      constMeta: kUpscaleFramesWithPaddingConstMeta,
      argValues: [frames, width, height, config],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kUpscaleFramesWithPaddingConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        ...
        argNames: ["frames", "width", "height", "config"],
      );
  ...
  late final _wire_upscale_frames_with_paddingPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_list_frame>,
                  ffi.Uint32, ffi.Uint32, ffi.Pointer<wire_EncodingConfig>)>>(
      'wire_upscale_frames_with_padding');
...
class wire_Frame extends ffi.Struct {
...
class wire_list_frame extends ffi.Struct {
...
class wire_FilterConfig extends ffi.Struct {
...
class wire_Filter_Simple extends ffi.Struct {
  external ffi.Pointer<wire_FilterConfig> field0;
}

class wire_Filter_Strong extends ffi.Struct {
  external ffi.Pointer<wire_FilterConfig> field0;
}
...
class wire_EncodingConfig extends ffi.Struct {
  @ffi.Uint8()
  external int method;
