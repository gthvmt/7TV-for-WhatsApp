...
fn wire_into_frames_impl(port_: MessagePort, bytes: impl Wire2Api<Vec<u8>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<Frame>, _>(
        WrapInfo {
        ...
        move || {
            ...
            move |task_callback| Result::<_, ()>::Ok(into_frames(api_bytes))
        },
    )
}
fn wire_upscale_frames_with_padding_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<Frame>, _>(
        ...
        move || {
            ...
            move |task_callback| {
                Result::<_, ()>::Ok(upscale_frames_with_padding(
...
fn wire_encode_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| Result::<_, ()>::Ok(encode(api_frames, api_config))
        },
    )
}
fn wire_calc_translucency_impl(port_: MessagePort, frames: impl Wire2Api<Vec<Frame>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, f32, _>(
        ...
        move || {
            let api_frames = frames.wire2api();
            move |task_callback| Result::<_, ()>::Ok(calc_translucency(api_frames))
        },
    )
}
